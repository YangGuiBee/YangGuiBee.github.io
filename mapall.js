/* ── 전체 모델 맵: 557개 알고리즘 전체를 유사 알고리즘군(family) 단위 리프로 안내하는 확장판 ── */
/* map.js(20개 세부분류 버전)와는 별도 파일 — 좌표는 트리 레이아웃 알고리즘으로 자동 계산되므로
   family를 추가/조정해도 NODE_POS를 손으로 다시 잡을 필요가 없다 */
